...
<div class="wrapper wrapper-content animated fadeInRight">
    <div class="ibox row float-e-margins">
        <div class="ibox-title">
            <h5><?php echo $the_row['name']; ?></h5>
            <div class="ibox-tools">
            </div>
        </div>
        <div class="ibox-content">

            <form method="post" action="<?php echo $save_url; ?>" role="form" class="form-horizontal m-t">
                <input type="hidden" name="id" value="<?php echo $the_row['id']; ?>">
    ...
    echo "\n";
                ...
                <div class="form-group">
                    ...
                    <div class="row col-sm-6">
                        <input type="text" name="name" value="<?php echo $the_row['name']; ?>" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="row input-group m-b col-sm-2">
                        <input type="text" name="s1_percent" value="<?php echo $the_row['s1_percent']; ?>" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="row input-group m-b col-sm-2">
                        <input type="text" name="s2_percent" value="<?php echo $the_row['s2_percent']; ?>" class="form-control">
                        <span class="input-group-addon">%</span>
                    </div>
                </div>
