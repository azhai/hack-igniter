...
<head>
    ...
    <link href="<?php echo $static_url; ?>/css/plugins/toastr/toastr.min.css" rel="stylesheet">
...
<!-- Toastr script -->
<script src="<?php echo $static_url; ?>/js/plugins/toastr/toastr.min.js"></script>
