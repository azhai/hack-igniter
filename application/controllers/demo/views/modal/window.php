    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            ...
            <div class="ibox ">
                ...
                <div class="ibox-content">
                    <p>
                        可以通过数据绑定或者Javascript来实现模态窗口的相关功能，如果使用数据绑定，可以为元素添加<code>data-</code>，如
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped">
                            ...
                            <tr>
                                ...
                                <td>false</td>
                                <td>
                                    <p><strong class="text-danger">推荐使用数据绑定方式，或使用<a href="http://api.jquery.com/load/">jQuery.load</a>
                                    </p>
                                    <p>远程URL示例：</p>
                                    <div class="highlight">
                                        <pre><code class="language-html" data-lang="html"><span class="nt">&lt;a</span> <span
                                                        class="na">data-toggle=</span><span
                                                        class="s">"modal"</span> <span class="na">href=</span><span
                                                        class="s">"remote.html"</span> <span
                                                        class="na">data-target=</span><span
                                                        class="s">"#modal"</span><span
                                                        class="nt">&gt;</span>Click me<span class="nt">&lt;/a&gt;</span></code></pre>
                                    </div>
                                </td>
                            </tr>
                            </tbody>
