                                    ...
                                    <div class="full-height-scroll">
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover">
                                                <tbody>
                                                    <tr>
                                                        <td class="client-avatar"><img alt="image" src="<?= $static_url ?>/img/a2.jpg"> </td>
                                                    ...
                                                    <tr>
                                                        <td class="client-avatar"><img alt="image" src="<?= $static_url ?>/img/a3.jpg"> </td>
                                                    ...
                                                    <tr>
                                                        <td class="client-avatar"><img alt="image" src="<?= $static_url ?>/img/a4.jpg"> </td>
                            ...
                            <div id="contact-1" class="tab-pane active">
                                <div class="row m-b-lg">
                                    <div class="col-lg-4 text-center">
                                        ...
                                        <div class="m-b-sm">
                                            <img alt="image" class="img-circle" src="<?= $static_url ?>/img/a2.jpg" style="width: 62px">
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
                                        <h3>
