                            ...
                            <div class="row">
                                <div class="col-sm-9">
                                    ...
                                    <a href="forum_post.html" class="forum-item-title">
                                        请问怎样对一个点拉伸或者改变其形状 </a>
                                    <div class="forum-sub-title">我最开始也这样，给你个建议哈，别硬背html标签了，知道并理解这个标签怎么用就行。然后把CSS看完并理解。
                                    </div>
                                </div>
                                <div class="col-sm-1 forum-info">
                                        <span class="views-number">
                        ...
                        <div class="forum-item">
                            <div class="row">
                                <div class="col-sm-9">
                                    ...
                                    <div class="forum-sub-title">匹配任意内容 find /etc/home -name "*" 显示目录/etc/home下的所有文件?
                                        匹配任意一个字符 find /etc/home -name "c?"
                                    </div>
                                </div>
                                <div class="col-sm-1 forum-info">
                                        <span class="views-number">
                            ...
                            <div class="row">
                                <div class="col-sm-9">
                                    ...
                                    <div class="forum-sub-title">
                                        林子大了什么鸟都有啊。楼主如果认为这位鹏哥讲的不好，应该指出来哪里讲的不好，并且把你觉的更好的讲课方案拿出来分享
                                    </div>
                                </div>
                                <div class="col-sm-1 forum-info">
                                        <span class="views-number">
                        ...
                        <div class="forum-item">
                            <div class="row">
                                <div class="col-sm-9">
                                    ...
                                    <div class="forum-sub-title">1.作用Linux系统中grep命令是一种强大的文本搜索工具，它能使用正则表达式搜索文本，并把匹
                                        配的行打印出来。grep全称是Global Regular Expression Print，表示全局正则表达式版本，它的使用权限是所有用户。
                                    </div>
                                </div>
                                <div class="col-sm-1 forum-info">
                                        <span class="views-number">
