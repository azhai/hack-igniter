                    ...
                    <div class="well">
                        ...
                        <div class="row diff-wrapper">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="changed">要对文本进行比较的时候，可以考虑使用
                                    google-diff-match-patch，它可以进行比较、匹配和生成补丁的操作，我们在这里展示一个简单的例子。首先我们必须接定好文本比较后的输出。假设我们有两段文本“123456789”和“012356889”，然后我们希望输出他们的“差异”，可是这个“差异”怎么表示呢？
                                </div>
                            </div>
                            <div class="col-md-4">
                                <h4>对比结果：</h4>
...
<!-- Diff march patch -->
<script src="<?php echo $static_url; ?>/js/plugins/diff_match_patch/diff_match_patch.js"></script>

<!-- jQuery pretty text diff -->
<script src="<?php echo $static_url; ?>/js/plugins/preetyTextDiff/jquery.pretty-text-diff.min.js"></script>
