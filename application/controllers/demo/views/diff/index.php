...
<!-- Diff march patch -->
<script src="<?= $static_url ?>/js/plugins/diff_match_patch/diff_match_patch.js"></script>

<!-- jQuery pretty text diff -->
<script src="<?= $static_url ?>/js/plugins/preetyTextDiff/jquery.pretty-text-diff.min.js"></script>
