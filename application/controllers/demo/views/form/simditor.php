...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $static_url; ?>/css/plugins/simditor/simditor.css"/>
...
<!-- simditor -->
<script type="text/javascript" src="<?php echo $static_url; ?>/js/plugins/simditor/module.js"></script>
<script type="text/javascript" src="<?php echo $static_url; ?>/js/plugins/simditor/uploader.js"></script>
<script type="text/javascript" src="<?php echo $static_url; ?>/js/plugins/simditor/hotkeys.js"></script>
<script type="text/javascript" src="<?php echo $static_url; ?>/js/plugins/simditor/simditor.js"></script>
<script>
