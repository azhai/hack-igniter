...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= $static_url ?>/css/plugins/simditor/simditor.css" />
...
<body class="gray-bg">
    ...
    <!-- simditor -->
    <script type="text/javascript" src="<?= $static_url ?>/js/plugins/simditor/module.js"></script>
    <script type="text/javascript" src="<?= $static_url ?>/js/plugins/simditor/uploader.js"></script>
    <script type="text/javascript" src="<?= $static_url ?>/js/plugins/simditor/hotkeys.js"></script>
    <script type="text/javascript" src="<?= $static_url ?>/js/plugins/simditor/simditor.js"></script>
    <script>
