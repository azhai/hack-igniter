...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo $static_url; ?>/css/plugins/markdown/bootstrap-markdown.min.css"/>
...
<!-- simditor -->
<script type="text/javascript" src="<?php echo $static_url; ?>/js/plugins/markdown/markdown.js"></script>
<script type="text/javascript" src="<?php echo $static_url; ?>/js/plugins/markdown/to-markdown.js"></script>
<script type="text/javascript" src="<?php echo $static_url; ?>/js/plugins/markdown/bootstrap-markdown.js"></script>
<script type="text/javascript" src="<?php echo $static_url; ?>/js/plugins/markdown/bootstrap-markdown.zh.js"></script>
