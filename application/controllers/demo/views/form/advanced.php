                ...
                <div class="ibox-content">
                    ...
                    <div class="text-center">
                        ...
                        <div class="m-r-md inline">
                            <input type="text" value="75" class="dial m-r-sm" data-fgColor="#1AB394" data-width="85"
                                   data-height="85"/>
                        </div>
                        <div class="m-r-md inline">
                            <input type="text" value="25" class="dial m-r" data-fgColor="#1AB394" data-width="85"
                                   data-height="85"/>
                        </div>
                        <div class="m-r-md inline">
                            <input type="text" value="50" class="dial m-r" data-fgColor="#1AB394" data-width="85"
                                   data-height="85"/>
                        </div>
                    </div>
                    <div class="text-center">
                        ...
                        <br/>
                        <div class="m-r-md inline">
                            <input type="text" value="75" class="dial m-r-sm" data-fgColor="#ED5565" data-width="85"
                                   data-height="85" data-cursor=true data-thickness=.3/>
                        </div>
                        <div class="m-r-md inline">
                            <input type="text" value="25" class="dial m-r" data-fgColor="#ED5565" data-width="85"
                                   data-height="85" data-step="1000" data-min="-15000" data-max="15000"
                                   data-displayPrevious=true/>
                        </div>
                        <div class="m-r-md inline">
                            <input type="text" value="60" class="dial m-r" data-fgColor="#ED5565" data-width="85"
        ...
        <div class="col-sm-7">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div>
                        <a class="btn btn-white pull-right btn-sm" href="https://github.com/IonDen/ion.rangeSlider"
                           target="_blank">API文档</a>
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <select data-placeholder="选择省份" class="chosen-select" multiple style="width:350px;"
                                    tabindex="4">
                                <option value="">请选择省份</option>
                                <option value="110000" hassubinfo="true">北京</option>
                                <option value="120000" hassubinfo="true">天津</option>
                        ...
                        <div class="col-md-4">
                            <fieldset>
                                ...
                                <div class="radio radio-success">
                                    <input type="radio" id="singleRadio2" value="option2" name="radioSingle1" checked=""
                    ...
                    <div class="row m-t">
                        <div class="col-sm-10">
                            ...
                            <div class="form-group">
                                ...
                                <div class="well">
                                    <a href="#" class="btn small demo colorpicker-element" id="demo_apidemo"
                                       data-color="rgb(255, 255, 255)">改变背景颜色</a>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="well">
                                    <div id="demo_cont" class="demo demo-auto inl-bl inline" data-container="#demo_cont"
                                         data-color="rgba(150,216,62,0.55)" data-inline="true"></div>
                                    <div class="demo demo-auto inl-bl inline" data-container="true"
                                         data-color="rgb(50,216,62)" data-inline="true"></div>
                                </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <a class="btn btn-white demo-destroy btn-block" href="#"><i
                                        class="glyphicon glyphicon-remove"></i> 销毁插件</a>
                            <a class="btn btn-white demo-create btn-block" href="#"><i
                                        class="glyphicon glyphicon-plus"></i> 重新创建</a>
                        </div>
                    </div>
                </div>
            </div>
