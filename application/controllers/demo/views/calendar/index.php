...
<head>
    ...
    <link href="<?php echo $static_url; ?>/css/plugins/fullcalendar/fullcalendar.css" rel="stylesheet">
    <link href="<?php echo $static_url; ?>/css/plugins/fullcalendar/fullcalendar.print.css" rel="stylesheet">
...
<script src="<?php echo $static_url; ?>/js/jquery-ui.custom.min.js"></script>

<!-- iCheck -->
<script src="<?php echo $static_url; ?>/js/plugins/iCheck/icheck.min.js"></script>

<!-- Full Calendar -->
<script src="<?php echo $static_url; ?>/js/plugins/fullcalendar/fullcalendar.min.js"></script>
