    ...
    <div class="row">
        ...
        <div class="col-sm-6">
            ...
            <div class="social-feed-box">
                ...
                <div class="social-body">
                    <p>
                        【最高富帅、最受欢迎的技术——Bootsrap】众所周知，Bootstrap 是最受欢迎的 HTML、CSS 和 JS 框架，用处非常之广泛，在开发响应式布局、移动设备优先的 WEB
                        项目中都极其重要，极客学院的相关课程已经更新完毕，简直分分钟变身IT大师==>开始学习
                    </p>
                    <p>
            ...
            <div class="social-feed-box">
                ...
                <div class="social-body">
                    <p>
                        5本《Node与Express开发》免费抽】本书涵盖Express 4.0，系统讲解利用Express开发Web应用的流程和步骤。通过实例讲授了开发网站和REST
