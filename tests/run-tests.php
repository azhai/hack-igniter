    ...
    for ($i = 1; $i < $argc; $i++) {
        ...
        while ($repeat) {
            ...
            switch ($switch) {
                ...
                // no break
                case 'w':
                    $failed_tests_file = fopen($argv[++$i], 'w+');
                    break;
                case 'a':
                    $failed_tests_file = fopen($argv[++$i], 'a+');
                    break;
                case 'W':
                    $result_tests_file = fopen($argv[++$i], 'w+');
                    break;
                case 'c':
                    $conf_passed = $argv[++$i];
                    break;
...
";
    ...
    $fp = fopen($file, "r") || error("Cannot open test file: $file");
